...
<head>
    ...
    <title>Matrix - Computer Store</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100">
    <!-- Header -->
    <header class="bg-[#556B2F] p-4 flex justify-between items-center">
        <div class="flex items-center">
            <div class="mr-2">
                <svg class="h-8 w-8" viewBox="0 0 24 24" fill="none">
                    <path d="M2 2h4v4H2V2zm8 0h4v4h-4V2zm8 0h4v4h-4V2zM2 10h4v4H2v-4zm8 0h4v4h-4v-4zm8 0h4v4h-4v-4zM2 18h4v4H2v-4zm8 0h4v4h-4v-4zm8 0h4v4h-4v-4z" fill="black"/>
                </svg>
            </div>
            <h1 class="text-2xl font-bold">MATRIX</h1>
        </div>
        <div class="space-x-2">
            <button class="bg-white text-black px-4 py-2 rounded-md font-medium">Sign Up</button>
            <button class="bg-green-600 text-white px-4 py-2 rounded-md font-medium">Login</button>
        </div>
    </header>
