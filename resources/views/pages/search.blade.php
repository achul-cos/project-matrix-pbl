...
<button class="" type="button" data-drawer-target="drawer-disabled-backdrop" data-drawer-show="drawer-disabled-backdrop" data-drawer-backdrop="false" aria-controls="drawer-disabled-backdrop">
       ...
       <ul class="space-y-2 font-medium ml-1">
          ...
          <li class="mt-4">
            ...
            <ul class="grid w-full gap-4 md:grid-cols-2">
               ...
               <li>
                  <input type="radio" id="gpu-rtx" name="gpu" value="gpu-gtx" class="hidden peer">
          ...
          <li class="mt-4">
            ...
            <div class="relative mb-6">
               <label for="steps-range" class="sr-only">Labels range</label>
               <input id="steps-range" type="range" value="0" min="0" max="16" step="8" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700">
          ...
          <li class="mt-12">
            ...
            <div class="relative mb-6">
               <label for="steps-range" class="sr-only">Labels range</label>
               <input id="steps-range" type="range" value="0" min="1" max="6" step="1" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700">
               <span class="text-sm text-gray-500 dark:text-gray-400 absolute start-0 -bottom-6">All</span>
 ...
 <section class="p-4 pt-8 pb-14 content-center">
    <p class="text-center text-xl max-md:text-lg">Hasil Pencarian "<span class="font-black">Lorem Ipsum</span>"</p>
    <p class="text-center text-lg max-md:text-md mt-2 text-gray-700 font-light italic">Filter Pencarian "<span class="font-bold">Lorem Ipsum</span>"</p>
</section>
