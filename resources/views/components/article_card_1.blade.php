<div class="">
    <div class="grid grid-cols-12 gap-0 bg-gray rounded-xl shadow-xl mx-8 mt-4 max-md:hidden">
        <div class="col-span-6 rounded-l-xl">
            <img src="{{ $foto_card_artikel ?? "../img/ad/placeholder1.png" }}" alt="" class="aspect-5/4 object-cover rounded-l-2xl h-full">
        </div>
